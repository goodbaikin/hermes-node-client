...
@dataclass
class PatchResult:
    """Result from applying V4A patch operations on a standalone node."""
    success: bool = False
    diff: str = ""
...
def _validate_operations(
    ...
    """
    # Deferred import keeps patch parsing lightweight and works both when
    # node_client is imported as a package and when hermes_node_client.py is
    # executed directly from its directory.
    try:
